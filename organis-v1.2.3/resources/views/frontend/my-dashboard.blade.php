					...
					<div class="my_card">
						<div class="row">
							<div class="col-lg-12">
								...
								<p>From your account dashboard. you can view your <strong><a href="{{ route('frontend.my-orders') }}">recent orders</a></strong>, <strong><a href="{{ route('frontend.my-profile') }}">profile</a></strong> and <strong><a href="{{ route('frontend.change-password') }}">change password</a></strong>.</p>
							</div>
						</div>
					</div>
				</div>
