			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('backend.partials.product_categories_table')
						</div>
					</div>
					<!--/Data grid/-->
					<!--Data Entry Form-->
					<div id="form-panel" class="card-body dnone">
						<form novalidate="" data-validate="parsley" id="DataEntry_formId">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="category_thumbnail">{{ __('Image') }}</label>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="subheader_image">{{ __('Subheader Image') }}</label>
										<div class="tp-upload-field">
											<input type="text" name="subheader_image" id="subheader_image" class="form-control" readonly>
											<a id="on_subheader_image" href="javascript:void(0);" class="tp-upload-btn"><i class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
										</div>
										<em>Recommended image size width: 1920px and height: 200px.</em>
										<div id="remove_subheader_image" class="select-image">
											<div class="inner-image" id="view_subheader_image"></div>
											<a onClick="onMediaImageRemove('subheader_image')" class="media-image-remove" href="javascript:void(0);"><i class="fa fa-remove"></i></a>
										</div>
									</div>
								</div>
								<div class="col-md-6"></div>
